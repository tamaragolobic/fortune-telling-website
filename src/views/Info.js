...
const info = () => {
    const informacije = [
        {
            naslov: 'Kdo in kaj sem?',
            besedilo: 'Da imam dobro intuicijo sem se zavedala zelo hitro, ampak kot vsi mi, je nikakor nisem želela slišati. V življenju sem imela kar nekaj globokih padcev in seveda potem tudi še močnejših prebojev nazaj v pozitivni svet. Moja stara mama (sedaj že pokojna) je bila zelo obiskana šlogarca in mi je vedno govorila, da bom nadaljevala njeno pot in zadnja leta spoznavam, da je imela prav. Zadnjih 15 let se ukvarjam samo z vedeževanjem. Vmes sem imela kratek premor, ampak to sem potrebovala, da sem lahko delala na sebi in še dodatno izostrila znanje in intuicijo.\n' +
